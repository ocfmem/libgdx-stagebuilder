...
public class NinePatchBuilder extends ActorBuilder {
    ...
    public NinePatchBuilder(AssetsInterface assets, ResolutionHelper resolutionHelper, LocalizationService localizationService) {
